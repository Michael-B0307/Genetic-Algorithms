...
# Function to calculate the fitness of a genome (counting of 1's in the string).
def fitness(genome):
    """Calculate the fitness of a genome.
    Fitness is measured as the sum of 1's in the genome.
...
def main():
    ...
    with open('fitness_history.csv', 'w') as file:
